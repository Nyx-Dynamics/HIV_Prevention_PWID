# CHANGELOG: AIDS and Behavior Publication Materials
## Version 1.0.0 (January 6, 2026)
### Initial Release for AIDS and Behavior
- **Consolidated Publication Materials:** Created a dedicated `AIDS and Behavior` directory to house all scripts, data, and figures specifically formatted for the journal submission.
