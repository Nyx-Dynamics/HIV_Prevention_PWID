...
- AI tools (Anthropic Claude 4.5), Jetbrains Junie, Zotero AI, Numpy, Matplotlib, Scipy, Arviz, OpenAI GPT 5.2 used as assistive technology for literature search, reference management and code refinement.  Author maintainces responsibility for all aspects of project and responsbility for use and software use.
