...
\textit{Structural barriers drive near-zero population-level effectiveness of HIV prevention among people who inject drugs:}\\
...
\newpage
\textbf{This supplement provides formal mathematical derivations and methodological foundations underlying the main analysis. All results here are intended to support, not extend, the conclusions of the primary manuscript.}
...
Signal-to-noise parameters for LAI-PrEP were derived from the randomized PrEP trial enrolling MSM and PWID}\cite{landovitz_CAB_2021, kelley_purpose2_2024}
