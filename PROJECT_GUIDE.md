...
- **`../data/bmc_public_health_figures_canonical/`**: Contains canonical versions of main figures in EPS, PNG, and TIFF formats.
...
Contains all files formatted for BMC Public Health journal submission:
- `BMC_Public_Health_Manuscript_BLINDED.docx/pdf` - Blinded manuscript
- `BMC_Public_Health_OnlineResource_S1.docx` - Mathematical foundations supplement
- `BMC_Public_Health_OnlineResource_S2.docx` - Supplementary figures
