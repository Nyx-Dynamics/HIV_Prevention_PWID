...
def main():
    ...
    parser.add_argument("--input", type=str, default="architectural_barrier_results.json",
                        help="Input JSON results file (default: architectural_barrier_results.json)")
    parser.add_argument("--output", type=str, default="figures/scenario_comparison.png",
                        help="Output image path (default: figures/scenario_comparison.png)")
