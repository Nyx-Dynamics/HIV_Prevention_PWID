    ...
    try:
        ...
        try:
            with pd.ExcelWriter(xlsx_path, engine='openpyxl') as writer_xl:
                ...
                df_scenarios.to_excel(writer_xl, sheet_name="Scenario Results", index=False)
                ...
                df_msm.to_excel(writer_xl, sheet_name="MSM Comparison", index=False)
                ...
                if "three_layer_decomposition" in current:
                    ...
                    df_layers.to_excel(writer_xl, sheet_name="Barrier Decomposition", index=False)
                ...
                if "barrier_decomposition_pct" in current:
                    ...
                    df_subtypes.to_excel(writer_xl, sheet_name="Architectural Subtypes", index=False)
...
# =============================================================================
# cascade_sensitivity_analysis.py imports ArchitecturalBarrierModel
ArchitecturalBarrierModel = StructuralBarrierModel
